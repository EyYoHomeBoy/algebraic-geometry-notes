...
\subsubsection{Localizations                           of Commutative Rings}
    ...
    \begin{lemma}
        ...
        $$
        We set $1 := 1_{X^{-1}R}:= \frac{1}{1}$ and $0 := 0_{X^{-1}R}:= \frac{0}{1}$. Then $(R,+,\cdot,0,1)$ is a commutative ring. Furthermore,
        $$
            \left\{\frac{a}{1} : a\in R \right\}
        $$
        defines a subring of $X^{-1}R$ isomorphic to $R$. 
    \end{lemma}
    \begin{proof}
        ...
        \begin{gather*}
            ...
            a \mapsto \frac{a}{1}
        \end{gather*} 
        This is clearly surjective and injective, hence the target of this function may be identified with $R$. 
    \end{proof}
    \begin{definition}
...
For this subsection $\pazocal{C}$ denotes the category whose objects are pairs consisting of a commutative ring and a multiplicative set in that ring. A morphism of such objects, $(R,X)\rightarrow (S,Y)$ is ring map, mapping every element in $X$ to an element in $Y$. Let $\pazocal{D}$ be the subcategory of $\pazocal{C}$ where an object in $\pazocal{D}$ is a pair $(R,X)\in \pazocal{C}$ with $X\subset R^\ast$.
    \begin{lemma}
        Let $\sigma:(R,R^\ast)\rightarrow (S,S^\ast)$ be a morphism in $\pazocal{C}$. There is a unique ring homomorphism $\overline{\sigma}: X^{-1}R\rightarrow S$ such that 
        $$
            \begin{tikzcd}
