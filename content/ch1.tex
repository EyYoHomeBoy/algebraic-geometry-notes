...
\begin{definition}
    A field extension, $N\supset K$ is \emph{normal}, if it is algebraic if for each $\alpha \in N$, the polynomial $\mathrm{Irr}(\alpha,K)$ is a product of linear factors over $N$.  
\end{definition}
