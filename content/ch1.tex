...
\end{definition}
\begin{definition}
    Let $R$ be an integral domain and $X\subset R\setminus 0$ a multiplicative set in $R$. Consider an ideal $I\subset R$. We define the \textit{localization ideal of $I$ in $X^{-1}R$}. To be the set 
...
\begin{lemma}\label{LocalizationIdealsDescribeIdealsGeneratedFromIdealsInSubring}
    Let $R$ be an integral domain and $X\subset R\setminus 0$ a multiplicative submonoid of $R$. Let $I\subset R$ be an ideal. Then $(X^{-1}R)I = X^{-1}I$. Consequently, $X^{-1}I$ is an ideal.
\end{lemma}
\begin{proof}
