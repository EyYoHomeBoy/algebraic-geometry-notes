...
\begin{definition}
    Let $z\in X$. Then $z$ is \textit{$\in$-minimal} if $\forall y(y\notin z \wedge y\notin X)$. We denote this $\min_\in(z,X)$.
\end{definition}
\begin{definition}
...
\begin{theorem}
    \begin{enumerate}
        \item If $\alpha\in \Omega$, then $\alpha=\emptyset$ or $\emptyset\ \mathrm{xor}\ \alpha$.
        \item If $\alpha\in \Omega$, then $\alpha\notin \alpha$.
        \item If $\alpha,\beta\in \Omega$, then $\alpha\in \beta\text{ xor } \beta\in \alpha \text{ or } \alpha = \beta$.
