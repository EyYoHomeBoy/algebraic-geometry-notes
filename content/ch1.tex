...
\begin{proof}
    ...
    $\bigcup_{\pazocal{V}\in C}\pazocal{V}\in X$ and is an upper bound of $C$. Then $X$ has a maximal element. A maximally linear independent set is a basis, hence $V$ has a basis.  
\end{proof}
\begin{lemma}
    Given a vector space $V$ over a field $K$, if $\pazocal{V},\pazocal{V}'$ are bases for $V$ over $K$, then they have the same cardinality.
\end{lemma}
\begin{lemma}
