...
\subsubsection{What Should the Polynomial Ring be?}
...
\begin{proposition}
    ...
    $$   
    then $Y\subset R[X]$ generates $R[X]$ and is a transcendence basis over $R$.
\end{proposition}
\begin{proof}
    ...
    $$
    This is equivalent to $Y$ being a transcendence basis over $R$. 
\end{proof}
In particular, we have the following result.
\begin{corollary}
    $R[X_\N^\mathrm{comm}]$ is a commutative $R$-algebra with transcendence basis $X$. 
\end{corollary}
\begin{remark}
...
\end{lemma}
\begin{proof}
    This is obvious since $\{\mathbf{x}^v : v\in \N^n\}$ form a basis of $R\left[\N^n\right]$.
\end{proof}
\begin{remark}
...
\begin{theorem}\label{PolynomialRingActsLikePolynomialRing}
    ...
    are rings containing $R$ as a subring. $R[x_1,\dots,x_n]$ is generated by $x_1,\dots,x_n$ as an $R$-algebra. Furthermore, $x_1,\dots,x_n$ are algebraically independent over $R$.
\end{theorem}
