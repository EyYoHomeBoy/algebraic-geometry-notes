...
\subsubsection{Splitting Fields}
    \begin{definition}
        Let $K$ be a field and $f\in K[X]$ with leading coefficient $a\in K$. A field extension $L\supset K$ is called a \emph{splitting field of $f$}, if there are $a_1,\dots,a_n\in L$ such that 
        $$
            f = a\prod_1^n (x-a_i)
        $$
        and 
    ...
    \end{definition}
    \begin{remark}
        Note that if $\deg \ f = 1$, then $K$ is a splitting field for $f$. 
    \end{remark}
    ...
    \begin{proof}
        ...
        \begin{gather*}
            \sigma_1 : K[X]/\langle p \rangle \simeq K'[x]/\langle \overline{\sigma}\rangle\\
...
\begin{proof}
    ...
    $$
        N = K(b)(a_1,\dots,a_n),
    $$ 
    hence $N$ is a splitting field of $f$ over $K(b)$. Similarly, $N(c)$ is a splitting field of $f = \overline{\sigma}(f)$ over $K(c)$. Then 
    $$
        [N : K(b)] = [N(c) : K(c)].
    $$
    Note that $[K(b) : K] = \Irr(b,K) = [K(c) : K]$, hence 
    $$
        [N : K] = [N : K(b)][K(b) : K] = [N(c) : K(c)][K(c) : K] = [N(c) : K] = [N(c) : N][N : K].
    $$
