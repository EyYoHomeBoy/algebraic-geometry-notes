...
\end{enumerate}
To actually give these syntactical meaning, we need to define rules for building well-formed formulae in $\verb|FOL|$. I.e. we need to define what strings of symbols, we are allowed to write in the language. A set potentially infinite list of non-logical symbols is called a \textit{signature} often denoted $\mathcal{L}$. 
