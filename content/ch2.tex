...
\subsubsection{Equivalence of Categories}
    ...
    for $i=0,1$. 
    \begin{lemma}
        Fix functors $\pazocal{F},\pazocal{G}:\pazocal{C}\rightarrow \pazocal{D}$. There is a bijection of natural transformations and functors $\pazocal{H}:\pazocal{C}\times \mathbbm{2}\rightarrow \pazocal{D}$ such that 
        $$
            \begin{tikzcd}
    ...
    \end{lemma}
    \begin{proof}
        Given a natural transformation $\alpha: \pazocal{F}\Rightarrow \pazocal{G}$, define 
        \begin{gather*} 
            ...
            (f,0\rightarrow 1) \mapsto ???
        \end{gather*}
        Conversely, let a functor $\pazocal{H}$ be given as described. For each object $X\in \pazocal{C}$, define 
        \begin{gather*}
            \alpha_X = \pazocal{H}(\id_X,0\rightarrow 1) 
        \end{gather*}
        $$
            (\id_X,0\rightarrow 1): (X,0)= \pazocal{I}_0(X)\rightarrow (X,1)=\pazocal{I}_1(X)
        $$

        $$
            \pazocal{H}(\id_X,0\rightarrow 1): \pazocal{H}(X,0)=\pazocal{H}\pazocal{I}_0(X)=\pazocal{F}(X)\rightarrow \pazocal{H}(X,1)=\pazocal{H}\pazocal{I}_1(X)=\pazocal{G}(X).
        $$
        \begin{align*}
            \pazocal{G}(f)\alpha_X &= \pazocal{G}(f)\pazocal{H}(\id_X,0\rightarrow 1) = \pazocal{I}_1\pazocal{H}(f)\pazocal{H}(\id_X,0\rightarrow 1)\\
        ...
        \end{align*}
        hence $\{\alpha_X\}$ defines a collection of components of a natural transformation $\alpha: \pazocal{F}\Rightarrow \pazocal{G}$.
    \end{proof}
