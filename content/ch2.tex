...
\subsection{A Topological Aside: Construction of $\R$ as a Completion of $\Q$}
    ...
    \end{proof}
    \subsubsection{The Geometric Series, $n$-basis representation of Real Numbers and the Uncountability of $\R$}
    \begin{definition}
        Let $r\in [0,1)$. We define the \emph{geometric series with common ratio $r$} to be the series
        $$
            \sum_0^\infty r^i
        $$ 
    \end{definition}
