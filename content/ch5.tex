...
\]
    ...
    \end{proposition}
    \begin{proof}
        Let $\overline{g}$ denote the image of $g_\ast$ in $\pazocal{O}_P(C)$. Pick $U$ and $U'$ as in Lemma~\ref{SecondTechnicalNonsingularModelLemma} with $U\subset \{g:\ast(P')\neq 0\}\cup \{P\}$. In other words, so that $\overline{g}\in \pazocal{O}_{P'}(C)$ for each $P'\in U$ with $P'\neq P$. Then 
        \begin{align*}
        ...
        \end{align*}
        Set $V= \Gamma(U)$ and $V'=\Gamma(U')$. Consider $\rho : V\rightarrow V', z\mapsto \overline{g}z$. By ... 
