...
\]
    ...
    \begin{proof}
        ...
        2. We may assume that $\overline{x}$ is transcendental over $K$. Note then that $dz\neq 0$, since for some non-zero $g\in  K[\overline{x}][t]\subset K(\overline{x})[t]$ of minimal degree, $g(\overline{x},z)=0$, hence 
        $$
    ...
    \end{proposition}
    \begin{proof}
        WLOG $L=K(C)$ for some affine curve $C\in K[x,y]$, hence we may assume $\pazocal{O}=\pazocal{O}_P(f)$ with $P=(0,0)$. Choose $N$ such that $\ord_P(\overline{x}'),\ord_P(\overline{y}')\geq -N$. Let $f\in \pazocal{O}$. Suppose first $f\in K[\overline{x},\overline{y}]$ Then 
        $$
        ...
        $$
            \ord_P(f') = \frac{1}{h^2}\left(hg'-gh'\right)  \geq -N
        $$
        Write 
        $$
    ...
    Fix a projective plane curve $C$ with nonsingular model $X$. Define $\Omega := \Omega_K(K(C))$. 
