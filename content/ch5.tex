...
\]
    ...
    \begin{proposition}
        ...
        \begin{enumerate}
            \item $(z)_0$ is an effective divisor of degree $n$.
    ...
    \begin{definition}
        Let $C$ be an irreducible projective plane curve with non-singular model. The \emph{genus} of $C$, denoted $g(C)$ or $g(X)$, is the smallest integer with 
        $$
            l_d \geq \deg \ d + 1 -g
        $$
        for each $d\in \Z[X]$. 
