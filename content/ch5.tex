...
\]
    ...
    \begin{lemma}\label{ExistenceOfGenusObservingDivisor}
        Consider a non-constant rational function $z$ on $X$. For any divisor $d\in \Z[X]$ there is a divisor $d'\in \Z[X]$ and an integer $r\geq 0$ such that 
        $$
            d'\leq r(z)_0
        $$
    \end{lemma}
    ...
    \begin{corollary}
        For any irreducible projective plane curve
        $$
            g(C) \leq g^\ast(C).
        $$
    \end{corollary}
