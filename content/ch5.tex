...
\subsection{Some Topology}
    ...
    \begin{lemma}\label{TopologicalSpaceIsNoetherianIfCoveredByNoetherianSubsets}
        Let $X$ be topological space covered by a family of subsets $\{Y_i\}$ such that each $Y_i$ with the trace topology with respect to $X$ is Noetherian. Then $X$ is Noetherian. 
    \end{lemma}
    \begin{proof}
    ...
    \begin{proof}
        ...
        Consider an arbitrary variety $X$. This is covered by open affine varieties $\{U_i\}$. It thus follows from Lemma~\ref{TopologicalSpaceIsNoetherianIfCoveredByNoetherianSubsets} that $X$ is Noetherian.  
    \end{proof}
    \begin{proposition}
