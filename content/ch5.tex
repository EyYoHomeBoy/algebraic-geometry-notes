...
\]
    ...
    \end{proof}
    \begin{theorem}
        Let $C$ be an irreducible projective plane curve with all multiple points ordinary. There is a non-singular projective curve $C'$ birationally equivalent to $C$. 
    \end{theorem}
    \begin{proof}
