...
\]
    ...
    \begin{lemma}
        ...
        \begin{enumerate}
            ...
            \item For any finite sequence $m_1,\dots,m_r\in \Z$ there is a $z\in K(X)$ such that $\ord_{P_i}(z)=m_i$. 
    ...
    \begin{proof}
        ...
        \end{gather*}
        is surjective (again cf. the proof of Lemma~\ref{BasicDivisorVectSpaceLemma}). It suffices to prove that $\lambda$ is not the zero map. 
    \end{proof}
