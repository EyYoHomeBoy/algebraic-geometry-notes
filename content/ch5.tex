...
\subsection{The Study of Curves \& Resolution of Singularities}
    ...
    \subsubsection{Blowing up Points in $\A^2$}
        ...
        \begin{example}
            ...
            $$
            Call the right-hand side $V$. Suppose $(a,b,c)\in V$ with $a\neq 0$. Then $c=\frac{b}{a}$, hence 
            $$
        ...
        \end{proof}
        \begin{lemma}
            There is an open affine neighborhood $W$ of $P$ in $C$ such that $W':=\varphi^{-1}(W)$ is an affine open subvariety in $C'$, $\varphi(W')=W$, $\Gamma(W')$ is module finite over $\Gamma(W)$ and $x^{r-1}\Gamma(W')\subset \Gamma(W)$. 
        \end{lemma}
        \begin{proof}
