...
\begin{proof}
    ...
    \end{gather*}
    which is well-defined by Proposition~\ref{PreImageOfPrimeIdealUnderRingMapIsPrime}. For an ideal $I\subset A$ one readily verifies that $f^{-1}(V(I))=V(\sigma(I))$ {\Large I haven't actually defined what this means: DO!}, which shows that $f$ is continuous. For an open set $U\subset \Spec \ A $... 
\end{proof}
\begin{definition}
