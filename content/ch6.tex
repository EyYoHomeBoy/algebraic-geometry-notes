...
\begin{example}
    ...
    Thirdly, an irreducible polynomial $f\in K[x_1,x_2]$, corresponds to $\eta_f:=\langle f\rangle\in \A^2_K$. Suppose $(a,b)\in f$, Then $\mathfrak{m}_{a,b}\supset $...   
\end{example}
...
\end{definition}
\begin{example}
    $\Spec \ R$ is trivially an example of an affine scheme. 
\end{example}
