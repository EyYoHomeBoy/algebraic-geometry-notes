...
\begin{definition}
    Consider a topological space $X$. Let $\pazocal{F}$ be a presheaf on the category $(\tau_X,\subset)$ where $\tau_X$ denotes the topology on $X$. $\pazocal{F}$ is called a \emph{sheaf on $X$} if in addition, 
    \begin{enumerate}
